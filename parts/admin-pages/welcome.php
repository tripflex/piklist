...
<script type="text/javascript">
  ...
  // {
  //   $('a[href="admin.php?page=piklist-settings"]')
  //     .pointer({
  //       'content': '<h3>Activate the Piklist Demo Add-On!</h3><p>Piklist comes with an Add-On that shows off some of the ways you can extend WordPress with Piklist.</p>'
  //       ,'position': {
  //         'edge': 'left'
  //         ,'align': 'center'
  //       }
